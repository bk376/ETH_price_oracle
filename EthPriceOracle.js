...
/* function that adds a new request whenever the oracle contract fires GetLatestEthPriceEvent */
...
async function processRequest(oracleContract, ownerAddress, id, callerAddress){
  ...
  while(retries < MAX_RETRIES){
    try {
      // it should retrieveLatestEthPrice and then call the oracle contract to set the latest ETH price.
